...
const MovieDetails = () => {
	...
	return (
		<div className="p-2 bg-background text-textPrimary max-w-screen-md mx-auto">
			<div className="flex flex-col md:gap-2 md:flex-row items-center md:items-start">
				<img
				...
				<div className="md:ml-8 mt-4 md:mt-0 w-full">
					...
					<div className="grid md:grid-cols-2 items-start gap-2 text-textPrimary mb-4 ">
						<div className="flex items-start gap-2 ">
							<FaRegClock className="text-lg" /> Runtime: {movie.Runtime}
						</div>
						<div className="flex items-start gap-2 ">
							<FaRegCalendarAlt className="text-lg" /> Released:{" "}
							{movie.Released}
						</div>
						<div className="flex items-start gap-2 ">
